...
public class Game {
	...
	public static void main(String[] args) {
		...
		//Player player0 = new StrategyPlayer("Strategy");
		Player player1 = new MyPlayer("Mine");
		Player player0 = new AggressivePlayer("Aggro");

		// Player player1 = new CowardlyPlayer("Coward");
		// Player player1 = new RandomPlayer("Random");
